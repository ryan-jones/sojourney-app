    ...
    if (user === null){
      ...
      this.userService.getTest(user._id)
        .subscribe((user)=> {
          ...
          this.user.arr.forEach((item, index)=>{
            if (item.nationality1 === undefined){
              this.selectedNationalityId1 = '';
            } else {
              this.selectedNationalityId1 = item.nationality1;
            }

            if (item.nationality2 === undefined){
              this.selectedNationalityId2 = '';
            } else {
              this.selectedNationalityId2 = item.nationality2;
            }
      ...
      this.country.getList()
        .subscribe((countries2) =>{
          ...
          // console.log("this.countries2", this.countries2)
...
//************* load itineraries on the map **************
  loadCountries(selectedNationalityId1, selectedNationalityId2){
    console.log("inside loadCountries");
   let countriesArray = [selectedNationalityId1, selectedNationalityId2]
   console.log("countriesArray in loadCountries()", countriesArray);
